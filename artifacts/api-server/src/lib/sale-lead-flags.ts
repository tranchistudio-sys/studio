...
const ESCALATION_KEYWORDS: Array<{ re: RegExp; reason: string }> = [
  ...
  { re: /gi[ảa]m th[eê]m|b[ớo]t (ch[uú]t|gi[áa]|th[eê]m)|r[ẻe] h[ơo]n|b[eê]n kia r[ẻe]|m[ắa]c qu[áa]|đ[ắa]t qu[áa]|\bdeal\b/i, reason: "Khách xin giảm thêm / so sánh giá / than mắc" },
