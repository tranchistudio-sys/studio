...
function RouterRoot() {
  ...
  // Khách lạ (chưa đăng nhập) vào "/" → ưu tiên trang Cho thuê đồ.
  // Không ảnh hưởng nhân viên/admin (đã redirect ở trên) hay chế độ xem thử của staff.
  if (location === "/" && !viewer && !publicPreview) {
    return <Redirect to="/cho-thue-do" />;
  }
