  ...
  return (
    <article className="group">
      ...
      >
        <div className="relative aspect-[4/5] sm:aspect-[3/4] bg-neutral-100 overflow-hidden">
          ...
          {album.coverImageUrl ? (
            <>
              ...
              />
              <div
                className="concept-card-title-hover absolute bottom-0 left-0 right-0 p-3 sm:p-4 pointer-events-none"
                style={{ transform: "translateZ(34px)" }}
              >
                <p className="font-serif text-base sm:text-lg text-white leading-snug drop-shadow-[0_2px_8px_rgba(0,0,0,.45)]">
                  {album.name}
                </p>
                {album.photoCount > 0 && (
        ...
        <div className="px-2.5 py-2 sm:hidden border-t border-neutral-100 bg-white">
          <p className="font-serif text-sm text-neutral-900 line-clamp-1">{album.name}</p>
        </div>
        {tags.length > 0 && (
